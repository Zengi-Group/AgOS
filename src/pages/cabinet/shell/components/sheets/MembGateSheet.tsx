...
function gateCopy(membership: MembershipStatus): { t: string; b: string; cta: string | null; act?: string } {
  if (membership === 'expired')
    return { t: 'Членство истекло', b: 'Текущие сделки можно довести до конца. Чтобы создавать и публиковать новые партии — оформите подписку.', cta: 'Оформить подписку', act: 'pay' }
  if (membership === 'pending')
    return { t: 'Заявка на рассмотрении', b: 'Продажа партий откроется после одобрения заявки и оформления подписки. Ответим в течение 3 рабочих дней.', cta: null }
