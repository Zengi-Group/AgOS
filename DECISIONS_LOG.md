...
**Files**: `d13_billing.sql` (+5 RPC, +3 колонки, +FSM revoked), `cross_check.sh` (CHECK 5 whitelist), `Docs/AGOS-Dok3-RPC-Catalog-v1_5.md` (RPC-BILL-12..16), `Docs/AGOS-Dok4-EventBus-v1_1.md` (B-08..B-11 + payload-таблица), `apex-brain/projects/agos/specs/membership-billing.md` (статус). Ветка `claude/linear-ars-267-f72a16`.
