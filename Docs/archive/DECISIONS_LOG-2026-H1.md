# DECISIONS LOG — AgOS · АРХИВ 2026-H1 (записи до 2026-07-01)

> Вынесено из DECISIONS_LOG.md при ротации 2026-07-25 (P4-гигиена, экономия контекста).
> Сюда попали: датированные записи до 2026-07-01 + записи старого формата `### D-XX — …`
> (эпоха слайсов 1–6, без дат). Порядок сохранён. Файл статичен — append только в живой лог.
